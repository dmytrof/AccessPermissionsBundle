...
class AccessAttributeTypeTest extends TypeTestCase
{
     ...
     * @param AccessAttribute|null $testObject
     */
    public function testSubmitValidData(?string $formData, ?AccessAttribute $testObject)
    {
        ...
        $this->assertEquals($testObject, $form->getData());
